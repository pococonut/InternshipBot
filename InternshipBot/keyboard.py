...
stud_reject_task_b2 = InlineKeyboardButton(text="Подробнее", callback_data="more_task_student_chosen")
stud_reject_task.add(stud_reject_task_b2).add(stud_reject_task_b1).add(menu)

stud_more_task = InlineKeyboardMarkup(row_width=2)
stud_more_task_b1 = InlineKeyboardButton('Свернуть', callback_data="stud_chosen_tasks")
stud_more_task_b2 = InlineKeyboardButton('Отказаться от задачи', callback_data="reject_task")
stud_more_task.add(stud_more_task_b1).add(stud_more_task_b2).add(menu)
